...
namespace ClassLibrary
{
	public class PowerLineAfter
	{
		public int[][][] schemes = new int[][][] { scheme1, scheme2, scheme3, scheme4, scheme5,
			...
			scheme54, scheme55, scheme56, scheme57, scheme58, scheme59, scheme60, scheme61,
			scheme62, scheme63, scheme64, scheme65, scheme66, scheme67, scheme68, scheme69,
			scheme70, scheme71};
		...
		public static int[][] scheme54 = new int[][]
		{
			new int[] { 932, 933, 1 }
		};

		public static int[][] scheme55 = new int[][]
		{
			new int[] { 933, 2841, 1 },
			new int[] { 934, 2841, 2 }
		};

		public static int[][] scheme56 = new int[][]
		{
			new int[] { 933, 2841, 1 },
			new int[] { 2841, 935, 2 }
		};

		public static int[][] scheme57 = new int[][]
		{
			new int[] { 933, 2841, 1 },
			new int[] { 7, 1, 1 }
		};

		public static int[][] scheme58 = new int[][]
		{
			new int[] { 933, 2841, 1 }
		};

		public static int[][] scheme59 = new int[][]
		{
			new int[] { 932, 934, 2 }
		};

		public static int[][] scheme60 = new int[][]
		{
			new int[] { 934, 2841, 2 },
			new int[] { 2841, 935, 2 }
		};

		public static int[][] scheme61 = new int[][]
		{
			new int[] { 935, 936, 1 },
			new int[] { 936, 938, 2 },
			new int[] { 938, 940, 1 }
		...
		public static int[][] scheme62 = new int[][]
		{
			new int[] { 935, 936, 1 },
			new int[] { 936, 938, 2 }
		};

		public static int[][] scheme63 = new int[][]
		{
			new int[] { 935, 936, 1 }
		};

		public static int[][] scheme64 = new int[][]
		{
			new int[] { 936, 938, 2 },
			new int[] { 938, 940, 1 }
		};

		public static int[][] scheme65 = new int[][]
		{
			new int[] { 936, 938, 2 },
			new int[] { 2839, 2840, 2 }
		};

		public static int[][] scheme66 = new int[][]
		{
			new int[] { 936, 938, 2 }
		};

		public static int[][] scheme67 = new int[][]
		{
			new int[] { 938, 940, 1 },
			new int[] { 940, 892, 1 }
		};

		public static int[][] scheme68 = new int[][]
		{
			new int[] { 938, 940, 1 }
		};

		public static int[][] scheme69 = new int[][]
		{
			new int[] { 935, 937, 1 }
		};

		public static int[][] scheme70 = new int[][]
		{
			new int[] { 7, 1, 1 }
		};
	}
